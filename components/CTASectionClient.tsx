...
export default function CTASectionClient({ data }: Props) {
  const { heading, subtitle, email, web3formsAccessKey, sectionLabel } = data;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!access_key || access_key === "YOUR_WEB3FORMS_ACCESS_KEY_HERE") {
        console.warn(
          "WEB3FORMS_ACCESS_KEY is missing. Simulating success for development.",
        );
